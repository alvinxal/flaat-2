...
const faqs = [
  {
    question: "Apakah harga bisa custom?",
    answer:
      "Bisa. Paket dipakai sebagai titik awal agar diskusi lebih cepat, lalu scope bisa disesuaikan dengan kebutuhan bisnis Anda.",
  },
  {
    question: "Apakah bisa bertahap atau cicilan?",
    answer:
      "Bisa dibahas sesuai nilai project dan alur pengerjaan supaya tetap nyaman untuk kedua pihak.",
  },
  {
    question: "Apakah ada revisi?",
    answer:
      "Ada. Revisi dasar masuk dalam scope, sedangkan perubahan tambahan di luar scope akan dibahas sebagai add-on.",
  },
  {
    question: "Berapa lama pengerjaan?",
    answer:
      "Timeline mengikuti paket dan kompleksitas kebutuhan, mulai dari sekitar 1 minggu sampai beberapa tahap implementasi.",
  },
  {
    question: "Apakah domain & hosting termasuk?",
    answer:
      "Untuk paket web tertentu, setup domain dan hosting sudah termasuk sesuai detail paket.",
  },
];
...
export default function PricingDeckPage() {
  return (
